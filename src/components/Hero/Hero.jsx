...
const Hero = () => {
	return (
		<div className="dark:bg-gray-950 dark:text-white duration-300 mt-10">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center">
					...
					<div className="space-y-5 order-2 sm:order-1 xl:pr-40 ">
						...
						<p data-aos="fade-up" data-aos-delay="300">
							Your partner in navigating the ever-evolving landscape of digital marketing. From
							conceptualization to execution, we craft tailored solutions that drive results and elevate your
